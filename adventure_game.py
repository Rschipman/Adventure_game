...
def intro():
    ...
    print_pause("You look around as you remember the cries of the "
     "tortured townfolk you have been sent to save from a vicious, unknown enemy.")
...
def the_house():
    ...
    if response == "1":
        ...
        if weapon_choice in holster:
            ...
            print_pause("Before you have a chance to strike you feel something forefully strike your head")
            print_pause(". . . ")
...
def the_village():
    if "victory" in win:
        print_pause("The village rejoices as you ride back in to your home, face beaming with your victory")
        print_pause("YOU WIN!")
        exit()
    else:
        if weapon_choice in holster:
            print_pause("The villagers throw old rottedd food at the greedy bastard they once believed to be a hero")
            print_pause("Your greed has caused you to completly forget you mission")
